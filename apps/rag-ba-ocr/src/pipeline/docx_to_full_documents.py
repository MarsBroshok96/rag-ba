...
from src.common.project_paths import OCR_EXPORT_ROOT, WORD_INBOX_DIR
...
def main() -> None:
    input_dir = WORD_INBOX_DIR
    assert input_dir.exists(), f"Word inbox not found: {input_dir}"
    
    output_root = OCR_EXPORT_ROOT
    output_root.mkdir(parents=True, exist_ok=True)

    docx_files = sorted(input_dir.glob("*.docx"))
    assert docx_files, "No .docx files found in data/inbox/word"
