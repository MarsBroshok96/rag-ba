...
from src.common.project_paths import OCR_EXPORT_ROOT, ROOT_LAYOUT_ROOT
...
def _page_image_path(doc_id: str, page_num: int, block: dict[str, Any]) -> str:
    ...
    return str(ROOT_LAYOUT_ROOT / doc_id / f"page{int(page_num):03d}.png")
